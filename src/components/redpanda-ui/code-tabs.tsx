...
import { Tabs, TabsContent, TabsContents, TabsList, type TabsProps, TabsTrigger } from '@/components/redpanda-ui/tabs';
import { useTheme } from '@/components/redpanda-ui/theme-provider';
