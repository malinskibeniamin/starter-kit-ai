  ...
  ({ className, orientation = 'vertical', ...props }, ref) => {
    return (
      <ListLayoutContext.Provider value={{ orientation }}>
        <div ref={ref} className={cn('flex min-h-0 w-full flex-col gap-4 p-4 sm:gap-6 sm:p-6', className)} {...props} />
...
const ListLayoutNavigation = React.forwardRef<HTMLDivElement, ListLayoutNavigationProps>(
  ({ className, children, ...props }, ref) => {
    return (
      <div ref={ref} className={cn('flex gap-1 border-b border-border', className)} {...props}>
        {children}
      </div>
    );
  },
