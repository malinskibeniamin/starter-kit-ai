...
function Command({ className, variant, size, ...props }: CommandProps) {
  return (
    <CommandPrimitive data-slot="command" className={cn(commandVariants({ variant, size }), className)} {...props} />
  );
}
