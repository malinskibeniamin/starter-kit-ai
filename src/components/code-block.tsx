...
import { ScrollArea, ScrollBar, ScrollViewport } from '@/components/scroll-area';
...
export const CodeBlock = ({
  ...
  return (
    <figure ref={ref} {...props} className={cn(codeBlockVariants({ size, width, maxHeight }), className)}>
      {title ? (
