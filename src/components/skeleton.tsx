...
function Skeleton({ className, variant, size, width, ...props }: SkeletonProps) {
  return <div data-slot="skeleton" className={cn(skeletonVariants({ variant, size, width }), className)} {...props} />;
}
...
function SkeletonGroup({ children, direction = 'vertical', spacing = 'default', className }: SkeletonGroupProps) {
